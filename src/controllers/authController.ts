...
export const userRegister = async (req: Request, res: Response) => {
    ...
    try {
        ...
        //     { id: createUser.id, email: createUser.email, usertype: createUser.usertype },
        //     process.env.JWT_SECRET as string,
        //     { expiresIn: "1d" }
        // );
        // res.json({ success: true, token, email: createUser.email, full_name: createUser.full_name, usertype: createUser.usertype });
